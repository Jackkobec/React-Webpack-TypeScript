...
export class Hello extends React.Component {
    ...
    render() {
        ...
        const r = Object.assign({}, this.state); //автоматическое заполнение переменной r по соовествующим полям стейта
        ...
        React.createElement("div", null,
            ...
            React.createElement("h1", null,
                ...
                r.lastName,
                " !"),
            React.createElement("input", { onChange: e => this.setState({ name: e.target.value }), onBlur: () => {
                    console.log('sss');
                    this.triggerValidation('name');
                } }),
